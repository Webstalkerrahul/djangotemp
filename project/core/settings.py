...
CSRF_TRUSTED_ORIGINS = ['https://genericinvoice.duckdns.org', 'http://genericinvoice.duckdns.org']# CSRF Settings
CSRF_TRUSTED_ORIGINS = ['https://genericinvoice.duckdns.org', 'http://genericinvoice.duckdns.org']
CSRF_COOKIE_SECURE = True
CSRF_COOKIE_DOMAIN = '.genericinvoice.duckdns.org'
CSRF_USE_SESSIONS = True
ALLOWED_HOSTS = ['*', 'djangotemp-8sn5.onrender.com','genericinvoice.duckdns.org', 'localhost', '127.0.0.1']
